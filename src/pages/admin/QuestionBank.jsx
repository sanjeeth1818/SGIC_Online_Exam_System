...
import { Search, Plus, Edit2, Trash2, ChevronLeft, Folder, HelpCircle, Check, X, AlertTriangle, Upload, FileText, Download, CheckCircle2, XCircle } from 'lucide-react';
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                    ...
                    <div>
                        ...
                        <p style={{ color: 'var(--text-secondary)', fontSize: '0.94rem', fontWeight: 500 }}>
                            {selectedCategory ? `Managing questions inside ${selectedCategory.name}` : 'Organize and manage your test questions'}
                        </p>
                    </div>
                </div>
                    ...
                    {filteredCategories.map(cat => (
                        ...
                        >
                            <div style={{
                                ...
                                color: cat.color, borderRadius: '20px',
                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                position: 'relative',
                                zIndex: 1,
                                border: `1px solid ${cat.color}10`
                            }}>
                                <Folder size={32} fill="currentColor" fillOpacity={0.15} />
                            </div>

                            <div style={{ flex: 1, textAlign: 'left', display: 'flex', flexDirection: 'column', height: '100%' }}>
                                <h3 style={{ fontSize: '1.375rem', fontWeight: 800, marginBottom: '0.375rem', color: 'var(--text-primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                    {cat.name}
                                </h3>
                                <div style={{
                                    color: 'var(--text-secondary)',
                                    ...
                                    <span style={{ color: cat.color }}>{cat.questionCount}</span>
                    ...
                    {filteredQuestions.length === 0 ? (
                        ...
                        filteredQuestions.map(q => (
                            ...
                            >
                                ...
                                <h4 style={{ fontSize: '1.25rem', fontWeight: 600, marginBottom: '1.5rem', lineHeight: 1.5, color: 'var(--text-primary)' }}>{q.text}</h4>
